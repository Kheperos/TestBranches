 ...
 */
class PlanType extends \Plan\Entity\PlanType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plan\\Entity\\PlanType' . "\0" . 'id', '' . "\0" . 'Plan\\Entity\\PlanType' . "\0" . 'type', '' . "\0" . 'Plan\\Entity\\PlanType' . "\0" . 'typeDescription'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlanType $proxy) {
