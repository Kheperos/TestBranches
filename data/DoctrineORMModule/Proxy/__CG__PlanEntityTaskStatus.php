 ...
 */
class TaskStatus extends \Plan\Entity\TaskStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plan\\Entity\\TaskStatus' . "\0" . 'id', '' . "\0" . 'Plan\\Entity\\TaskStatus' . "\0" . 'statusCode', '' . "\0" . 'Plan\\Entity\\TaskStatus' . "\0" . 'statusDescription'];
        }
